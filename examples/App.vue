<template>
    <div id="app">
        <a-layout>
            <a-layout-header style="background: #fff; border-bottom: 1px solid #ccc; width: 100%">
                <div class="_fc-t-header">
                    ...
                    <div class="_fc-t-menu">
                        <a-button  @click="setJson"> 导入JSON</a-button>
                        <a-button  @click="setOption"> 导入Options</a-button>
        ...
        <a-modal :title="title[type]" :zIndex="100000" v-model:visible="state" class="_fc-t-dialog">
